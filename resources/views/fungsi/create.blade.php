        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h3 class="font-weight-bolder text-info text-gradient">Tambah Data fungsi</h3>
                </div>
                <div class="modal-body">
                    <form id="formTambahData" action="{{ route('fungsi.store') }}" method="POST">
                        @csrf
                        <div class="form-group">
                            <label for="deskripsi" class="col-form-label">Masukkan Deskripsi fungsi:</label>
