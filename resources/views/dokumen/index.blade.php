...
<body class="g-sidenav-show bg-gray-100">
            ...
            <div class="col-12">
                <div class="card mb-4">
                    <div class="card-header d-flex align-items-center justify-content-between">
                        ...
                        <button type="button" class="btn bg-gradient-primary" data-bs-toggle="modal" data-bs-target="#tambahData"><i class="fa-solid fa-plus me-2"></i>Tambah Dokumen</button>
                    </div>
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table align-items-center mb-0 displayw" id="example" style="width:100%">
                                <thead>
                                    <tr>
                                        <th class="text-uppercase text-primary text-sm font-weight-bold">Nama Dokumen</th>
  ...
  @include('dokumen.create')
  @include('dokumen.delete')
  @include('dokumen.edit')
  @include('dokumen.detail')
