...
<body class="g-sidenav-show bg-gray-100">
            ...
            <div class="col-12">
                <div class="card mb-4">
                    <div class="card-header d-flex align-items-center justify-content-between">
                        <h4 class="card-title">Jam Layanan Dinas</h4>
                        <button type="button" class="btn bg-gradient-primary" data-bs-toggle="modal" data-bs-target="#tambahData"><i class="fa-solid fa-plus me-2"></i>Tambah Waktu</button>
                    </div>
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table align-items-center mb-0 displayw" id="example" style="width:100%">
                                <thead>
                                    <tr>
                                        <th class="text-uppercase text-primary text-sm font-weight-bold">Hari</th>
                                        <th class="text-uppercase text-primary text-sm font-weight-bold">Waktu</th>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <span class="badge badge-sm {{ $item->status == 'buka' ? 'bg-gradient-success' : 'bg-gradient-danger' }}">
                                                {{ $item->status == 'buka' ? 'Buka' : 'Libur' }}
                                            </span>
                                        </td>
                                        <td class="text-center">
  ...
  @include('jam_layanan.create')
  @include('jam_layanan.delete')
  @include('jam_layanan.edit')
