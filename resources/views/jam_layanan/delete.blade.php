        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="deleteDataTitle{{ $item->id }}">Hapus Waktu </h5>
                ...
                <div class="modal-body">
                    <div class="py-3 text-center">
                        ...
                        <p>Nama Hari: {{ $item->nama_hari }}</p>
                        <p>Jam Layanan: {{ $item->jam_buka }} - {{ $item->jam_tutup }}</p>
                    </div>
                </div>
                <div class="modal-footer">
                    <form action="{{ route('jam_layanan.destroy', $item->id) }}" method="POST">
                        @csrf
                        @method('DELETE')
