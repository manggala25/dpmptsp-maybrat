        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h3 class="font-weight-bolder text-info text-gradient">Buat Data Homepage</h3>
                </div>
                <div class="modal-body">
                    <form id="formTambahData" action="{{ route('menuhome.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" id="paragraf_hero" name="paragraf_hero"></textarea>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" id="paragraf_layanan" name="paragraf_layanan"></textarea>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" id="paragraf_portal" name="paragraf_portal"></textarea>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" id="paragraf_berita" name="paragraf_berita"></textarea>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" id="paragraf_ucapan" name="paragraf_ucapan"></textarea>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" id="paragraf_instansi" name="paragraf_instansi"></textarea>
                        </div>
                    </form>
                </div>
