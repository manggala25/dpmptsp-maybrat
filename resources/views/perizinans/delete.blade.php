        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="deleteDataTitle{{ $item->id }}">Hapus Perizinan</h5>
                ...
                <div class="modal-body">
                    <div class="py-3 text-center">
                        ...
                        <p>Nama Perizinan: {{ $item->nama_izin }}</p>
                    </div>
                </div>
                <div class="modal-footer">
                    <form action="{{ route('perizinans.destroy', $item->id) }}" method="POST">
                        @csrf
                        @method('DELETE')
