        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="deleteDataTitle{{ $item->id }}">Hapus Tahapan</h5>
                ...
                <div class="modal-body">
                    <div class="py-3 text-center">
                        ...
                        <p>Nama Tahapan: {{ $item->nama_tahapan }}</p>
                    </div>
                </div>
                <div class="modal-footer">
                    <form action="{{ route('tahapanpengajuan.destroy', $item->id) }}" method="POST">
                        @csrf
                        @method('DELETE')
