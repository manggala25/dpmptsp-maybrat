        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="deleteDataTitle{{ $item->id }}">Hapus Program Kerja</h5>
                ...
                <div class="modal-body">
                    <div class="py-3 text-center">
                        ...
                        <p>Nama Program Kerja: {{ $item->nama_program }}</p>
                    </div>
                </div>
                <div class="modal-footer">
                    <form action="{{ route('program_kerja.destroy', $item->id) }}" method="POST">
                        @csrf
                        @method('DELETE')
