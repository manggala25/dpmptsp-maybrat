        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="deleteDataTitle{{ $item->id }}">Hapus Tugas Dinas</h5>
                ...
                <div class="modal-body">
                    <div class="py-3 text-center">
                        ...
                        <p>Nama Tugas Dinas: {{ $item->deskripsi }}</p>
                    </div>
                </div>
                <div class="modal-footer">
                    <form action="{{ route('tugas_dinas.destroy', $item->id) }}" method="POST">
                        @csrf
                        @method('DELETE')
