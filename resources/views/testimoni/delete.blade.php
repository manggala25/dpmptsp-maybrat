        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="deleteDataTitle{{ $item->id }}">Hapus Data Testimoni</h5>
                ...
                <div class="modal-body">
                    <div class="py-3 text-center">
                        ...
                        <h6 class="text-secondary">Nama Testimoni: {{ $item->nama }}</h6>
                        <p  class="text-secondary">Testimoni: {{ $item->ucapan }}</p>
                    </div>
                </div>
