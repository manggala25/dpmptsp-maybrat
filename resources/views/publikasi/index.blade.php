...
<body class="g-sidenav-show bg-gray-100">
                        ...
                        <div class="table-responsive">
                            <table class="table align-items-center mb-0 displayw" id="example" style="width:100%">
                                <thead>
                                    <tr>
                                        {{-- <th></th> --}}
                                        <th class="text-uppercase text-primary text-sm font-weight-bold">Nama publikasi</th>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <h6 class="mb-0 text-sm">{{ $item->nama_publikasi }}</h6>
                                            </div>
                                        </td>
  ...
  @include('publikasi.detail')
  @include('publikasi.create')
  @include('publikasi.delete')
  @include('publikasi.edit')
