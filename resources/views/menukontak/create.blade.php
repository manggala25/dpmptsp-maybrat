        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h3 class="font-weight-bolder text-info text-gradient">Tambah Data Kontak Page</h3>
                </div>
                <div class="modal-body">
                    <form id="formTambahData" action="{{ route('menukontak.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
