...
<body class="g-sidenav-show bg-gray-100">
            ...
            <div class="col-12">
                <div class="card mb-4">
                    <div class="card-header d-flex align-items-center justify-content-between">
                        <h4 class="card-title">Daftar Kategori Persyaratan</h4>
                        <button type="button" class="btn bg-gradient-primary" data-bs-toggle="modal" data-bs-target="#tambahData"><i class="fa-solid fa-plus me-2"></i>Tambah Kategori Persyaratan</button>
                    </div>
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table align-items-center mb-0 displayw" id="example" style="width:100%">
                                <thead>
                                    <tr>
                                        <th>No.</th>
                                        <th class="text-uppercase text-primary text-sm font-weight-bold">Nama Kategori</th>
  ...
  @include('kategoripersyaratan.create')
  {{-- @include('kategoripersyaratan.detail') --}}
  @include('kategoripersyaratan.delete')
  @include('kategoripersyaratan.edit')
